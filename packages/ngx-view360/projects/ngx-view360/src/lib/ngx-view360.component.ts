...
export class NgxView360Component
  extends View360Interface
  implements AfterViewInit, OnDestroy, OnChanges
{
  ...
  @Output("loadStart") public loadStartEmitter =
    new EventEmitter<LoadStartEvent>();
  @Output("load") public loadEmitter = new EventEmitter<LoadEvent>();
  @Output("loadFailed") public loadFailedEmitter =
    new EventEmitter<LoadFailedEvent>();
  @Output("projectionChange") public projectionChangeEmitter =
    new EventEmitter<ProjectionChangeEvent>();
  @Output("resize") public resizeEmitter = new EventEmitter<ResizeEvent>();
  @Output("beforeRender") public beforeRenderEmitter =
    new EventEmitter<BeforeRenderEvent>();
  @Output("render") public renderEmitter = new EventEmitter<RenderEvent>();
  @Output("inputStart") public inputStartEmitter =
    new EventEmitter<InputStartEvent>();
  @Output("inputEnd") public inputEndEmitter =
    new EventEmitter<InputEndEvent>();
  @Output("viewChange") public viewChangeEmitter =
    new EventEmitter<ViewChangeEvent>();
  @Output("staticClick") public staticClickEmitter =
    new EventEmitter<StaticClickEvent>();
